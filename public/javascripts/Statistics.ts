window.onload=function(){
    //totalLbl
    let totalLbl = document.getElementById('total');
    //winlbl
    let winlbl = document.getElementById('wins');
    //lostLbl
    let lostLbl = document.getElementById('losses');
    //avgLbl
    let avgLbl = document.getElementById('avg');
    //saveBtn
    let saveBtn = document.getElementById('saveBtn');

    let totalWons =localStorage.getItem("totalWons");
    let totalLost =localStorage.getItem("totalLost");
    let totals =localStorage.getItem("totals");
    let avg =localStorage.getItem("avg");
